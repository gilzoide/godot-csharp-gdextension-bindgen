...
public class LuaScript
{
	...
	protected LuaScript([NotNull] ScriptExtension @object)
	{
		_object = @object;
	}
	...
	{
		return _object.CanInstantiate();
	}

	public bool InstanceHas(GodotObject @base_object)
	{
		return _object.InstanceHas(@base_object);
	}

	public bool HasSourceCode()
	{
		return _object.HasSourceCode();
	}

	public string GetSourceCode()
	{
		return _object.GetSourceCode();
	}

	public void SetSourceCode(string @source)
	{
		_object.SetSourceCode(@source);
	}

	public Godot.Error Reload(bool @keep_state = false)
	{
		return _object.Reload(@keep_state);
	}

	public Script GetBaseScript()
	{
		return _object.GetBaseScript();
	}

	public Godot.StringName GetInstanceBaseType()
	{
		return _object.GetInstanceBaseType();
	}

	public Godot.StringName GetGlobalName()
	{
		return _object.GetGlobalName();
	}

	public bool HasScriptSignal(Godot.StringName @signal_name)
	{
		return _object.HasScriptSignal(@signal_name);
	}

	public Godot.Collections.Array<Godot.Collections.Dictionary> GetScriptPropertyList()
	{
		return _object.GetScriptPropertyList();
	}

	public Godot.Collections.Array<Godot.Collections.Dictionary> GetScriptMethodList()
	{
		return _object.GetScriptMethodList();
	}

	public Godot.Collections.Array<Godot.Collections.Dictionary> GetScriptSignalList()
	{
		return _object.GetScriptSignalList();
	}
