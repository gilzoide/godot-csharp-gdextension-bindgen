...
public class LuaScriptResourceFormatLoader
{
	...
	protected LuaScriptResourceFormatLoader(StringName @class) : this(Godot.ClassDB.Instantiate(@class))
	{
	}
	protected LuaScriptResourceFormatLoader(Variant variant) : this((ResourceFormatLoader) variant)
	{
	}
	protected LuaScriptResourceFormatLoader([NotNull] ResourceFormatLoader @object)
	{
		_object = @object;
	}
